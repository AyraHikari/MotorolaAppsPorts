...
.method private savePngAttributes(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p2, p0, v2, v3}, Ljava/util/zip/CRC32;->update([BII)V
...
.method private saveWebpAttributes(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 6475
    :cond_6
    sget-object p0, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_VP8:[B
    ...
    sget-object p0, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_VP8L:[B
    ...
    sget-object p1, Landroidx/exifinterface/media/ExifInterface;->WEBP_SIGNATURE_2:[B

    array-length p2, p1

    add-int/2addr p0, p2

    invoke-virtual {v1, p0}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->writeInt(I)V

    .line 6489
    invoke-virtual {v1, p1}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->write([B)V
    ...
    const-string p1, "WebP files with only VP8 or VP8L chunks are currently not supported"
    ...
    const-string p1, "Encountered invalid length while parsing WebP chunk type"
    ...
    const-string p2, "Failed to save WebP file"
