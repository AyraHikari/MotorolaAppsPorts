...
.method public final run()V
    ...
    .line 4
    invoke-static {v2}, Lcom/google/android/gms/common/api/internal/zack;->zac(Lcom/google/android/gms/common/api/internal/zack;)Lcom/google/android/gms/common/api/ResultTransform;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/gms/common/api/internal/zacn;->zakz:Lcom/google/android/gms/common/api/Result;
    ...
    .line 5
    iget-object v3, p0, Lcom/google/android/gms/common/api/internal/zacn;->zaky:Lcom/google/android/gms/common/api/internal/zack;

    invoke-static {v3}, Lcom/google/android/gms/common/api/internal/zack;->zad(Lcom/google/android/gms/common/api/internal/zack;)Lcom/google/android/gms/common/api/internal/zacm;

    move-result-object v3

    iget-object v4, p0, Lcom/google/android/gms/common/api/internal/zacn;->zaky:Lcom/google/android/gms/common/api/internal/zack;

    .line 6
    invoke-static {v4}, Lcom/google/android/gms/common/api/internal/zack;->zad(Lcom/google/android/gms/common/api/internal/zack;)Lcom/google/android/gms/common/api/internal/zacm;

    move-result-object v4

    invoke-virtual {v4, v1, v2}, Lcom/google/android/gms/common/api/internal/zacm;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    .line 7
    invoke-virtual {v3, v2}, Lcom/google/android/gms/common/api/internal/zacm;->sendMessage(Landroid/os/Message;)Z
    :try_end_0
    ...
    .line 12
    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/zacn;->zaky:Lcom/google/android/gms/common/api/internal/zack;

    invoke-virtual {v0, p0}, Lcom/google/android/gms/common/api/GoogleApiClient;->zab(Lcom/google/android/gms/common/api/internal/zack;)V
    ...
    invoke-virtual {v4, v0, v2}, Lcom/google/android/gms/common/api/internal/zacm;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    .line 17
    invoke-virtual {v3, v0}, Lcom/google/android/gms/common/api/internal/zacm;->sendMessage(Landroid/os/Message;)Z
    :try_end_1
    ...
    invoke-virtual {v1, p0}, Lcom/google/android/gms/common/api/GoogleApiClient;->zab(Lcom/google/android/gms/common/api/internal/zack;)V
