...
.method public delete(Lcom/google/android/gms/auth/api/credentials/Credential;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/gms/auth/api/credentials/CredentialsApi;->delete(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/auth/api/credentials/Credential;)Lcom/google/android/gms/common/api/PendingResult;
...
.method public disableAutoSignIn()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-interface {v0, p0}, Lcom/google/android/gms/auth/api/credentials/CredentialsApi;->disableAutoSignIn(Lcom/google/android/gms/common/api/GoogleApiClient;)Lcom/google/android/gms/common/api/PendingResult;
...
.method public getHintPickerIntent(Lcom/google/android/gms/auth/api/credentials/HintRequest;)Landroid/app/PendingIntent;
    ...
    check-cast p0, Lcom/google/android/gms/auth/api/Auth$AuthCredentialsOptions;

    .line 10
    invoke-static {v0, p0, p1}, Lcom/google/android/gms/internal/auth-api/zzq;->zzc(Landroid/content/Context;Lcom/google/android/gms/auth/api/Auth$AuthCredentialsOptions;Lcom/google/android/gms/auth/api/credentials/HintRequest;)Landroid/app/PendingIntent;
...
.method public request(Lcom/google/android/gms/auth/api/credentials/CredentialRequest;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/gms/auth/api/credentials/CredentialsApi;->request(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/auth/api/credentials/CredentialRequest;)Lcom/google/android/gms/common/api/PendingResult;

    move-result-object p0

    new-instance p1, Lcom/google/android/gms/auth/api/credentials/CredentialRequestResponse;

    invoke-direct {p1}, Lcom/google/android/gms/auth/api/credentials/CredentialRequestResponse;-><init>()V
...
.method public save(Lcom/google/android/gms/auth/api/credentials/Credential;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-interface {v0, p0, p1}, Lcom/google/android/gms/auth/api/credentials/CredentialsApi;->save(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/auth/api/credentials/Credential;)Lcom/google/android/gms/common/api/PendingResult;
