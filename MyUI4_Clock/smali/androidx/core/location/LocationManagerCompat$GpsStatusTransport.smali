...
.method private synthetic a(Ljava/util/concurrent/Executor;)V
    .locals 1
...
.method private synthetic c(Ljava/util/concurrent/Executor;)V
    .locals 1
...
.method private synthetic g(Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
    .locals 1
...
.method public synthetic b(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;->a(Ljava/util/concurrent/Executor;)V
...
.method public synthetic d(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;->c(Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method public synthetic f(Ljava/util/concurrent/Executor;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;->e(Ljava/util/concurrent/Executor;I)V

    return-void
.end method

.method public synthetic h(Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;->g(Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
...
.method public onGpsStatusChanged(I)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/d;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/c;-><init>(Landroidx/core/location/LocationManagerCompat$GpsStatusTransport;Ljava/util/concurrent/Executor;I)V
