...
.method public static a(Landroid/app/FragmentManager;Ljava/util/ArrayList;IZLzy;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0}, Lvb0$c;-><init>()V
    ...
    .line 6
    invoke-static {v1, p4}, Lyy;->b(Landroid/os/Bundle;Lzy;)V

    .line 7
    invoke-virtual {v0, v1}, Landroid/app/DialogFragment;->setArguments(Landroid/os/Bundle;)V

    .line 8
    sget-object p1, Lvb0;->g:Ljava/lang/String;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 3
    iget-object v2, p0, Lvb0$c;->e:Ljava/util/List;
    ...
    .line 4
    iget-object p1, p0, Lvb0$c;->e:Ljava/util/List;
    ...
    .line 7
    iget-object p2, p0, Lvb0$c;->f:Lzy;

    invoke-virtual {p2}, Lzy;->T()Lwy;

    move-result-object p2

    sget-object v1, Lwy;->g:Lwy;
    ...
    sget-object v1, Lfc0;->r:Lfc0;

    .line 9
    invoke-interface {p2, v1}, Lhc0;->i(Lfc0;)V

    .line 10
    :cond_1
    iget-wide v1, p1, Lvb0$d;->c:J
    ...
    iget p2, p0, Lvb0$c;->c:I

    iget-boolean v1, p0, Lvb0$c;->g:Z

    iget-object p0, p0, Lvb0$c;->f:Lzy;

    invoke-static {v0, p1, p2, v1, p0}, Lvb0;->d(Landroid/content/Context;Ljava/lang/String;IZLzy;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iput-object v0, p0, Lvb0$c;->e:Ljava/util/List;
    ...
    invoke-static {v0}, Lyy;->a(Landroid/os/Bundle;)Lzy;

    move-result-object v0

    iput-object v0, p0, Lvb0$c;->f:Lzy;

    .line 7
    new-instance v0, Lvb0$e;

    iget-object v1, p0, Lvb0$c;->e:Ljava/util/List;

    iget v2, p0, Lvb0$c;->c:I

    invoke-direct {v0, p1, v1, v2}, Lvb0$e;-><init>(Landroid/content/Context;Ljava/util/List;I)V

    iput-object v0, p0, Lvb0$c;->d:Landroid/widget/ListAdapter;
    ...
    iget-object p1, p0, Lvb0$c;->d:Landroid/widget/ListAdapter;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-interface {p0}, Lvb0$a;->x0()V
