...
.method public a()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->a()Lh;
    ...
    invoke-direct {v2, v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$a;-><init>(Li;)V
    ...
    invoke-virtual {v3}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->a()Lh;

    move-result-object v3

    invoke-interface {v3, v2}, Lh;->h(Lg;)V
    :try_end_0
    ...
    .line 7
    invoke-virtual {v1, v2, v3, v3}, Li;->i(ILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    .line 9
    :cond_1
    iget-object p0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->b:Ljava/util/List;
