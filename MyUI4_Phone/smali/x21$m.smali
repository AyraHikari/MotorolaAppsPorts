...
.method public constructor <init>(Lh31;)V
    ...
    .line 2
    iput v0, p0, Lx21$m;->h:I

    const v0, 0x7f0801fd

    .line 3
    iput v0, p0, Lx21$m;->i:I

    .line 4
    iput-object p1, p0, Lx21$m;->c:Lh31;
...
.method public G0(Lcom/android/incallui/incall/impl/CheckableLabeledButton;Z)V
    ...
    .line 1
    iget-object p2, p0, Lx21$m;->n:Ljava/lang/CharSequence;

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lx21$m;->o:Ljava/lang/CharSequence;
    ...
    .line 3
    iget-object p0, p0, Lx21$m;->c:Lh31;

    invoke-interface {p0}, Lh31;->h()V
...
.method public a(Lcom/android/incallui/incall/impl/CheckableLabeledButton;)V
    ...
    .line 1
    iput-object p1, p0, Lx21$m;->g:Lcom/android/incallui/incall/impl/CheckableLabeledButton;

    if-eqz p1, :cond_5

    .line 2
    iget-boolean v0, p0, Lx21$m;->d:Z
    ...
    .line 7
    iget-boolean v0, p0, Lx21$m;->k:Z

    if-nez v0, :cond_3

    .line 8
    iget v0, p0, Lx21$m;->h:I
    ...
    iget-object v0, p0, Lx21$m;->o:Ljava/lang/CharSequence;

    goto :goto_3

    :cond_4
    iget-object v0, p0, Lx21$m;->n:Ljava/lang/CharSequence;
...
.method public d(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Lx21$m;->e:Z

    .line 2
    iget-object v0, p0, Lx21$m;->g:Lcom/android/incallui/incall/impl/CheckableLabeledButton;

    if-eqz v0, :cond_1

    .line 3
    iget-boolean p0, p0, Lx21$m;->d:Z
...
.method public e(Landroid/telecom/CallAudioState;)V
    ...
    .line 1
    iget-object v0, p0, Lx21$m;->p:Landroid/widget/ImageView;
    ...
    invoke-direct {v0, p1}, Ln51;-><init>(Landroid/telecom/CallAudioState;)V

    .line 6
    iget-boolean v3, v0, Ln51;->d:Z

    iput-boolean v3, p0, Lx21$m;->j:Z
    ...
    iput-object p1, p0, Lx21$m;->l:Ljava/lang/String;
    :try_end_0
    ...
    :cond_3
    :goto_2
    iget-boolean p1, v0, Ln51;->e:Z

    iput-boolean p1, p0, Lx21$m;->f:Z

    .line 11
    iget p1, v0, Ln51;->c:I

    iput p1, p0, Lx21$m;->h:I

    .line 12
    iget p1, v0, Ln51;->a:I

    iput p1, p0, Lx21$m;->i:I

    .line 13
    iget p1, v0, Ln51;->b:I

    .line 14
    iget-object v0, p0, Lx21$m;->c:Lh31;

    invoke-interface {v0}, Lh31;->a()Landroid/content/Context;
    ...
    iput-object p1, p0, Lx21$m;->m:Ljava/lang/CharSequence;
    ...
    .line 15
    iget-object p1, p0, Lx21$m;->c:Lh31;

    .line 16
    invoke-interface {p1}, Lh31;->a()Landroid/content/Context;
    ...
    iput-object p1, p0, Lx21$m;->n:Ljava/lang/CharSequence;

    new-array p1, v2, [Ljava/lang/CharSequence;

    .line 18
    iget-object v0, p0, Lx21$m;->m:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Lx21$m;->o:Ljava/lang/CharSequence;

    .line 21
    iget-object p1, p0, Lx21$m;->g:Lcom/android/incallui/incall/impl/CheckableLabeledButton;

    invoke-virtual {p0, p1}, Lx21$m;->a(Lcom/android/incallui/incall/impl/CheckableLabeledButton;)V
...
.method public f(Landroid/widget/ImageView;)V
    ...
    .line 1
    iput-object p1, p0, Lx21$m;->p:Landroid/widget/ImageView;
...
.method public setChecked(Z)V
    ...
    .line 2
    iget-object p0, p0, Lx21$m;->g:Lcom/android/incallui/incall/impl/CheckableLabeledButton;
