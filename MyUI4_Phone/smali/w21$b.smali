...
# direct methods
.method public constructor <init>(Li31;III)V
    .locals 0
    ...
    .line 3
    iput-object p1, p0, Lw21$b;->c:Li31;

    .line 4
    iput p2, p0, Lw21$b;->d:I

    .line 5
    iput p3, p0, Lw21$b;->e:I

    .line 6
    iput p4, p0, Lw21$b;->f:I
...
.method public H0(Lcom/android/incallui/incall/impl/CheckableLabeledButton;Z)V
    ...
    .line 1
    iget-object p1, p0, Lw21$b;->j:Lcom/android/incallui/incall/impl/CheckableLabeledButton;
    ...
    iget v1, p0, Lw21$b;->e:I

    goto :goto_0

    :cond_0
    iget v1, p0, Lw21$b;->f:I
    ...
    .line 4
    invoke-virtual {p0, p2}, Lw21$b;->e(Z)V
...
.method public a(Lcom/android/incallui/incall/impl/CheckableLabeledButton;)V
    ...
    .line 1
    iget-object v0, p0, Lw21$b;->j:Lcom/android/incallui/incall/impl/CheckableLabeledButton;

    invoke-static {v0}, Lw21$c;->a(Lcom/android/incallui/incall/impl/CheckableLabeledButton;)V

    .line 2
    iput-object p1, p0, Lw21$b;->j:Lcom/android/incallui/incall/impl/CheckableLabeledButton;

    if-eqz p1, :cond_2

    .line 3
    iget-boolean v0, p0, Lw21$b;->g:Z

    invoke-virtual {p1, v0}, Landroid/widget/LinearLayout;->setEnabled(Z)V

    .line 4
    iget-boolean v0, p0, Lw21$b;->h:Z
    ...
    iget-boolean v2, p0, Lw21$b;->i:Z

    if-eqz v2, :cond_1

    iget p0, p0, Lw21$b;->e:I

    goto :goto_1

    :cond_1
    iget p0, p0, Lw21$b;->f:I
