...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Leu1;->c(IILjava/util/function/IntFunction;Ljava/util/Comparator;)Ljava/util/Spliterator;
.end annotation
...
.method public constructor <init>(Ljava/util/Spliterator$OfInt;Ljava/util/function/IntFunction;ILjava/util/Comparator;)V
    ...
    .line 1
    iput-object p2, p0, Leu1$c;->d:Ljava/util/function/IntFunction;

    iput p3, p0, Leu1$c;->e:I

    iput-object p4, p0, Leu1$c;->f:Ljava/util/Comparator;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 2
    iput-object p1, p0, Leu1$c;->c:Ljava/util/Spliterator$OfInt;
...
.method public estimateSize()J
    ...
    .line 1
    iget-object p0, p0, Leu1$c;->c:Ljava/util/Spliterator$OfInt;
...
.method public forEachRemaining(Ljava/util/function/Consumer;)V
    ...
    .line 1
    iget-object v0, p0, Leu1$c;->c:Ljava/util/Spliterator$OfInt;

    iget-object p0, p0, Leu1$c;->d:Ljava/util/function/IntFunction;

    new-instance v1, Lht1;

    invoke-direct {v1, p1, p0}, Lht1;-><init>(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;)V
...
.method public getComparator()Ljava/util/Comparator;
    ...
    .line 2
    iget-object p0, p0, Leu1$c;->f:Ljava/util/Comparator;
...
.method public tryAdvance(Ljava/util/function/Consumer;)Z
    ...
    invoke-direct {v1, p1, p0}, Lit1;-><init>(Ljava/util/function/Consumer;Ljava/util/function/IntFunction;)V
...
.method public trySplit()Ljava/util/Spliterator;
    ...
    .line 2
    :cond_0
    new-instance v1, Leu1$c;

    iget-object v2, p0, Leu1$c;->d:Ljava/util/function/IntFunction;

    iget v3, p0, Leu1$c;->e:I

    iget-object p0, p0, Leu1$c;->f:Ljava/util/Comparator;

    invoke-direct {v1, v0, v2, v3, p0}, Leu1$c;-><init>(Ljava/util/Spliterator$OfInt;Ljava/util/function/IntFunction;ILjava/util/Comparator;)V
