...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Ll3;->a:Landroid/widget/ProgressBar;
...
.method public b()Landroid/graphics/Bitmap;
    ...
    .line 1
    iget-object p0, p0, Ll3;->b:Landroid/graphics/Bitmap;
...
.method public c(Landroid/util/AttributeSet;I)V
    ...
    .line 1
    iget-object v0, p0, Ll3;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Ll3;->c:[I
    ...
    .line 2
    invoke-virtual {p1, v2}, Lr4;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Ll3;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    invoke-virtual {p1, p2}, Lr4;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Ll3;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lx9;->b()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p0, v1, p2}, Ll3;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    .line 4
    invoke-interface {v0, p0}, Lx9;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Ll3;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    invoke-static {p1, p0, v2}, Ll3$a;->a(Landroid/graphics/drawable/LayerDrawable;Landroid/graphics/drawable/LayerDrawable;I)V
    ...
    .line 18
    iget-object v2, p0, Ll3;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_7

    .line 19
    iput-object v0, p0, Ll3;->b:Landroid/graphics/Bitmap;

    .line 20
    :cond_7
    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {p0}, Ll3;->a()Landroid/graphics/drawable/shapes/Shape;
...
.method public final e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v4, v5}, Ll3;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
