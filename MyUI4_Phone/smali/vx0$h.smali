...
.method public constructor <init>(Lvx0;)V
    ...
    .line 1
    iput-object p1, p0, Lvx0$h;->a:Lvx0;
...
# virtual methods
.method public synthetic a(Lvx0$k;)V
    .locals 0

    .line 1
    iget-object p0, p0, Lvx0$h;->a:Lvx0;

    iget p0, p0, Lvx0;->d0:I

    invoke-interface {p1, p0}, Lvx0$k;->g(I)V
...
.method public onCrsDataUpdated(IIZ)V
    ...
    .line 2
    sget-boolean p1, Lvx0;->j0:Z

    if-eqz p1, :cond_0

    iget-object p0, p0, Lvx0$h;->a:Lvx0;

    iget-object p1, p0, Lvx0;->c0:Lo11;

    if-eqz p1, :cond_0

    .line 3
    invoke-virtual {p0, p1}, Lvx0;->T(Lo11;)V

    .line 4
    sput-boolean p2, Lvx0;->j0:Z
...
.method public onSipDtmfReceived(ILjava/lang/String;)V
    ...
    .line 3
    iget-object p1, p0, Lvx0$h;->a:Lvx0;

    invoke-static {p2}, Lv51;->b(Ljava/lang/String;)I

    move-result p2

    iput p2, p1, Lvx0;->d0:I

    .line 4
    iget-object p1, p0, Lvx0$h;->a:Lvx0;

    iget-object p1, p1, Lvx0;->l:Ljava/util/Set;
    ...
    .line 5
    iget-object v0, p0, Lvx0$h;->a:Lvx0;

    iget-object v0, v0, Lvx0;->b0:Landroid/os/Handler;

    new-instance v1, Lxw0;

    invoke-direct {v1, p0, p2}, Lxw0;-><init>(Lvx0$h;Lvx0$k;)V
