...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lc/b/a/a/b;->autoCompleteTextViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/g;->j:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lc/b/a/a/k;->MaterialAutoCompleteTextView:[I

    sget v5, Lc/b/a/a/j;->Widget_AppCompat_AutoCompleteTextView:I
    ...
    sget p3, Lc/b/a/a/k;->MaterialAutoCompleteTextView_android_inputType:I
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/g;->i:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/j0;->J(Z)V

    iget-object p1, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;
    ...
    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/j0;->I(I)V
    ...
    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/j0;->p(Landroid/widget/ListAdapter;)V

    iget-object p1, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;

    new-instance p3, Lcom/google/android/material/textfield/g$a;

    invoke-direct {p3, p0}, Lcom/google/android/material/textfield/g$a;-><init>(Lcom/google/android/material/textfield/g;)V

    invoke-virtual {p1, p3}, Landroidx/appcompat/widget/j0;->L(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic a(Lcom/google/android/material/textfield/g;)Landroidx/appcompat/widget/j0;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;
...
.method private d()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;

    invoke-virtual {v5}, Landroidx/appcompat/widget/j0;->x()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/g;->h:Landroidx/appcompat/widget/j0;
    ...
    iget-object v2, p0, Lcom/google/android/material/textfield/g;->j:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/g;->j:Landroid/graphics/Rect;
...
.method private e(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/material/textfield/g;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/textfield/g;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public showDropDown()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/g;->i:Landroid/view/accessibility/AccessibilityManager;
