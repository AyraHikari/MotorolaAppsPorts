...
# static fields
.field static final k:Lcom/bumptech/glide/load/data/j$b;
...
.field private final g:Lcom/bumptech/glide/load/data/j$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/data/j;->k:Lcom/bumptech/glide/load/data/j$b;
...
.method public constructor <init>(Lcom/bumptech/glide/load/o/g;I)V
    ...
    sget-object v0, Lcom/bumptech/glide/load/data/j;->k:Lcom/bumptech/glide/load/data/j$b;

    invoke-direct {p0, p1, p2, v0}, Lcom/bumptech/glide/load/data/j;-><init>(Lcom/bumptech/glide/load/o/g;ILcom/bumptech/glide/load/data/j$b;)V

    return-void
.end method

.method constructor <init>(Lcom/bumptech/glide/load/o/g;ILcom/bumptech/glide/load/data/j$b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/bumptech/glide/load/data/j;->e:Lcom/bumptech/glide/load/o/g;

    iput p2, p0, Lcom/bumptech/glide/load/data/j;->f:I

    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->g:Lcom/bumptech/glide/load/data/j$b;
...
.method private c(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/bumptech/glide/load/data/j;->g:Lcom/bumptech/glide/load/data/j$b;
    ...
    :cond_0
    iget p2, p0, Lcom/bumptech/glide/load/data/j;->f:I
    ...
    invoke-direct {p2, v1, v0, p1}, Lcom/bumptech/glide/load/e;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method private g(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {v1, v2, v3}, Lcom/bumptech/glide/t/c;->b(Ljava/io/InputStream;J)Ljava/io/InputStream;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lcom/bumptech/glide/load/data/j;->i:Ljava/io/InputStream;
    ...
    :goto_1
    iget-object p1, p0, Lcom/bumptech/glide/load/data/j;->i:Ljava/io/InputStream;
    ...
    invoke-direct {v1, v2, p1, v0}, Lcom/bumptech/glide/load/e;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method private j(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    invoke-direct {p3, v1, v0}, Lcom/bumptech/glide/load/e;-><init>(Ljava/lang/String;I)V
    ...
    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;

    :try_start_1
    invoke-virtual {p3}, Ljava/net/HttpURLConnection;->connect()V

    iget-object p3, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;

    invoke-virtual {p3}, Ljava/net/HttpURLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p3

    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->i:Ljava/io/InputStream;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_3

    iget-boolean p3, p0, Lcom/bumptech/glide/load/data/j;->j:Z
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p2, p4, p3, p1}, Lcom/bumptech/glide/load/e;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p1, p2, v0}, Lcom/bumptech/glide/load/e;-><init>(Ljava/lang/String;I)V
...
.method public b()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/data/j;->i:Ljava/io/InputStream;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/data/j;->h:Ljava/net/HttpURLConnection;
...
.method public cancel()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/data/j;->j:Z
...
.method public f(Lcom/bumptech/glide/g;Lcom/bumptech/glide/load/data/d$a;)V
    ...
    :try_start_0
    iget-object v4, p0, Lcom/bumptech/glide/load/data/j;->e:Lcom/bumptech/glide/load/o/g;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/o/g;->h()Ljava/net/URL;
    ...
    iget-object v7, p0, Lcom/bumptech/glide/load/data/j;->e:Lcom/bumptech/glide/load/o/g;

    invoke-virtual {v7}, Lcom/bumptech/glide/load/o/g;->e()Ljava/util/Map;
