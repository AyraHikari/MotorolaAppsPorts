.class public Lcom/bumptech/glide/load/p/f/d;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/p/f/d;->a:Landroid/content/Context;
...
.method private d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/p/f/d;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/p/f/d;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/p/f/d;->a:Landroid/content/Context;
...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/load/p/f/d;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lcom/bumptech/glide/load/p/f/d;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;IILcom/bumptech/glide/load/i;)Lcom/bumptech/glide/load/n/v;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/p/f/d;->c(Landroid/net/Uri;IILcom/bumptech/glide/load/i;)Lcom/bumptech/glide/load/n/v;
...
.method public bridge synthetic b(Ljava/lang/Object;Lcom/bumptech/glide/load/i;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/p/f/d;->h(Landroid/net/Uri;Lcom/bumptech/glide/load/i;)Z
...
.method public c(Landroid/net/Uri;IILcom/bumptech/glide/load/i;)Lcom/bumptech/glide/load/n/v;
    ...
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/load/p/f/d;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lcom/bumptech/glide/load/p/f/d;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lcom/bumptech/glide/load/p/f/d;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lcom/bumptech/glide/load/p/f/a;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
