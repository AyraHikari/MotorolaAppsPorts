...
.field private u:Landroidx/appcompat/widget/k0;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v0, p0, Landroidx/appcompat/widget/l0$a;->s:I

    iput v1, p0, Landroidx/appcompat/widget/l0$a;->t:I

    goto :goto_0

    :cond_0
    iput v1, p0, Landroidx/appcompat/widget/l0$a;->s:I

    iput v0, p0, Landroidx/appcompat/widget/l0$a;->t:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/l0$a;->u:Landroidx/appcompat/widget/k0;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/l0$a;->v:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/l0$a;->u:Landroidx/appcompat/widget/k0;

    invoke-interface {v3, v0, v1}, Landroidx/appcompat/widget/k0;->f(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroidx/appcompat/widget/l0$a;->v:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroidx/appcompat/widget/l0$a;->u:Landroidx/appcompat/widget/k0;

    invoke-interface {v1, v0, v2}, Landroidx/appcompat/widget/k0;->e(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroidx/appcompat/widget/l0$a;->s:I
    ...
    iget v0, p0, Landroidx/appcompat/widget/l0$a;->t:I
...
.method public setHoverListener(Landroidx/appcompat/widget/k0;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/l0$a;->u:Landroidx/appcompat/widget/k0;
